...
from app.models import (  # noqa: E402,F401
    ambulance, audit_log, dispatch, emergency, family_link, family_link_note,
    hospital, hospital_alert, mci, medical_record, notification_subscription,
    patient_profile, patient_telemetry, tenant, traffic_snapshot, user,
)
